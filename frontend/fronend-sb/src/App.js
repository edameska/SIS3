...
class App extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (searchQuery) {
      axios
        .get(`http://88.200.63.148:8121/products/search/${searchQuery}`, { withCredentials: true })
        .then((response) => {
          this.setState({
  ...
  QLogout = () => {
    axios
      .post(`http://88.200.63.148:8121/users/logout`, {}, { withCredentials: true })
      .then((res) => {
        this.setState({
          CurrentPage: "home",
  ...
  QSetUser = (obj) => {
    ...
    cookies.set("userSession", obj, { path: "/" }); // Save the user session in a cookie
  };
  ...
  componentDidMount() {
    ...
    if (userSession) {
      ...
      axios
        .get("http://88.200.63.148:8121/users/login", { withCredentials: true })
        .then((response) => {
            ...
            <div className="container-fluid">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form className="form-inline d-lg-none" onSubmit={this.handleSubmit}>
                  ...
                  <button className="btn btn-outline-success my-2 my-sm-0 search" type="submit">
                    Search
                  </button>
                </form>
              </div>
